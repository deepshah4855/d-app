...
@Component({
  selector: 'kt-reception-db',
  templateUrl: './reception-db.component.html',
  styleUrls: ['./reception-db.component.scss']
})
export class ReceptionDBComponent implements OnInit {
